...
const weddingStyles = [
  { id: "classic", label: "Classic", count: 15 },
  { id: "modern", label: "Modern", count: 12 },
  { id: "vintage", label: "Vintage", count: 8 },
  { id: "rustic", label: "Rustic", count: 10 },
  { id: "luxury", label: "Luxury", count: 6 },
  { id: "beach", label: "Beach", count: 7 },
  { id: "minimalist", label: "Minimalist", count: 9 },
  { id: "romantic", label: "Romantic", count: 11 }
]

const colorThemes = [
  { id: "rose-gold", label: "Rose Gold", count: 8 },
  { id: "golden", label: "Golden", count: 6 },
  { id: "silver", label: "Silver", count: 5 },
  { id: "blush-pink", label: "Blush Pink", count: 10 },
  { id: "navy-blue", label: "Navy Blue", count: 4 },
  { id: "emerald-green", label: "Emerald Green", count: 3 },
  { id: "purple", label: "Purple", count: 7 },
  { id: "black-white", label: "Black & White", count: 12 }
]

const durationOptions = [
  { id: "15-30", label: "15-30 seconds", count: 20 },
  { id: "30-45", label: "30-45 seconds", count: 15 },
  { id: "45-60", label: "45-60 seconds", count: 8 },
  { id: "60+", label: "60+ seconds", count: 5 }
]

const specialFeatures = [
  { id: "music", label: "Background Music", count: 25 },
  { id: "animation", label: "Animations", count: 18 },
  { id: "photos", label: "Photo Integration", count: 22 },
  { id: "rsvp", label: "RSVP Integration", count: 12 },
  { id: "countdown", label: "Countdown Timer", count: 8 },
  { id: "guest-book", label: "Guest Book", count: 6 }
]

export function WeddingFilter() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Wedding Style</CardTitle>
        </CardHeader>
            ...
            <div className="flex flex-wrap gap-2">
              {selectedStyles.map(style => (
                <Badge key={style} variant="outline" className="text-xs">
                  {weddingStyles.find(s => s.id === style)?.label}
                </Badge>
              ))}
